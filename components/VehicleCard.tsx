...
export default function VehicleCard({
  ...
  return (
    <Link
      ...
      className="group relative block overflow-hidden rounded-sm bg-surface transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_32px_-12px_rgba(201,162,39,0.35)]"
    >
